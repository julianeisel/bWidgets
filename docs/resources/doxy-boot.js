 ...
 *
 *
 * From https://github.com/Velron/doxygen-bootstrapped.git
 * (feature/support-doxygen-1.1.12+ branch) with own modifications.
 */
...
$( document ).ready(function() {
  ...
  $('#MSearchSelectWindow').detach().appendTo('#MSearchBox');
  $('#MSearchSelectWindow').addClass('dropdown-menu');
  $('#MSearchResultsWindow').detach().appendTo('#MSearchBox');
  $('#MSearchSelectWindow').addClass('dropdown-menu');
  ...
  */
  $('#MSearchSelect').mouseover(function(){
    $('#MSearchSelectWindow').css('left', '0px');
  });
  $('#MSearchSelectWindow').mouseover(function(){
    $('#MSearchSelectWindow').css('left', '0px');
  });
  ...
  function update_search_results_window() {
    ...
    $('#search-results-window').css('left', '0px');
    $('#search-results-window').css('top', '40px');
  }
