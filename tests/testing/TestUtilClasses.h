...
{
public:
	constexpr int foo() const {return 23;}
};
...
public:
	...
	constexpr RefType foo() const& {return CONST_LREF;}
	RefType foo() & {return NON_CONST_LREF;}
	constexpr RefType foo() const&& {return CONST_RREF;}
	RefType foo() && {return NON_CONST_RREF;}
};
...
{
public:
	explicit ExplicitConstructibleFromInt(int i) :
		NonTrivialConstructors(i)
	{}
};
